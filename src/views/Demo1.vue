<template>
  <div class="demo1">
    <h1>This is an about page Demo1</h1>
    <meta charset="UTF-8" />
    ...
    >
      <a
        ...
        >Close Menu</a
      >
      <a href="#food" @click="w3_close()" class="w3-bar-item w3-button">Food</a>
    ...
    <div class="w3-top">
      <div class="w3-white w3-xlarge" style="max-width:1200px;margin:auto">
        <div class="w3-button w3-padding-16 w3-left" @click="w3_open()">☰</div>
...
export default {
  ...
  data() {
    return {
      imageLink: "https://images.app.goo.gl/iBg2ZzKC21VJrQbj8",
    };
  },
  methods: {
    w3_open() {
